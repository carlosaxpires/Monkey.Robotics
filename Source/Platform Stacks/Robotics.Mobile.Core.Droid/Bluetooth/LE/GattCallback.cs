namespace Robotics.Mobile.Core.Bluetooth.LE
{
    ...
    public class GattCallback : BluetoothGattCallback
    {
        ...
        public override void OnCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, GattStatus status)
        {
            ...
            Console.WriteLine("OnCharacteristicWrite: " + characteristic.GetStringValue(0));

            this.CharacteristicValueWritten(this, new CharacteristicWriteEventArgs
            {
                Characteristic = new Characteristic(characteristic, gatt, this),
                Status = Converters.ToGattCommunicationStatus(status)
            });
        }
